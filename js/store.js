...
const DEFAULT_STATE = {
  ...
  nutricoins: 0,                // moneda que SÍ se compra con dinero (ver "Comprar NutriCoins" en Ajustes) -- nunca compra Pausas de Ruta ni nada que reemplace constancia real, solo extras (preguntas de más a SuSana, cosas así). Gemas y NutriCoins conviven pero no se mezclan.
